...
export const SETTINGS_SCHEMA = [
  ...
  {
    group: 'Wards (curse removal)',
    items: [
      { key: 'wardsPerClear', label: 'Wards earned per goal cleared', type: 'range', min: 0, max: 3, step: 1, def: 1,
        help: 'A ward removes one curse. Wards bank until spent.' },
      { key: 'wardSpend', label: 'How wards are spent', type: 'select', def: 'manual',
        options: [['manual', 'Player clicks the curse to remove'], ['auto', 'Automatically on a random curse']] },
    ],
  },
  {
